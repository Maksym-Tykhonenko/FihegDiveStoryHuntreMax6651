...
const NeskinchnStukKruzheckv = () => {
  ...
  return (
    <View style={{ width: dimensions.width * 0.9, flex: 0, alignSelf: 'center', height: dimensions.height * 0.25 }}>
      <WebView
...
export default NeskinchnStukKruzheckv;